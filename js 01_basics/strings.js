...
//codePointat is different from charCodeAt in that it can handle characters represented by surrogate pairs (i.e., characters outside the Basic Multilingual Plane).
...
// //Symtax: string.slice(startIndex, endIndex);
// //if stratIndex<0,the method becomes slice(string.length + startIndex, endIndex) or simply count the same posns from end
