...
console.log("Accessing elements of the array:", myArr2);
console.log(myArr[1]);
...
- start/end can be negative (counts from end) and goes towards right after that
*/
...
console.log("hi", arr1.slice(-2)); // Expected output: Array [40, 50]
